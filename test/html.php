...
body {
  ...
  padding: 0px;
    ...
    <body><div class="container-fluid killmg">
    <div class="row killmg">
        <div class="col-md-12 killmg">
            <nav class="navbar navbar-inverse killmg" role="nagivation" border-radius="0" style="border-radius=0; background-color:0xFFFFFF">
